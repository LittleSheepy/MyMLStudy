...
def parse_opt():
    ...
    # pt_file = r"F:\sheepy\00MyMLStudy\ml10Repositorys\02yolov5s\yolov5-7.0\yolov5-7.0\runs\train-seg1\06NMSZ\exp_nmsz1024_13\weights\\best.pt"  # 06 nmsz
    ...
    img_dir = r"J:\000LG测试\pk\lzps\result0.1\OK\/"
    ...
    parser.add_argument('--name', default='exp_lzps_pk_test', help='save results to project/name')
