...
def parse_opt():
    ...
    pt_file = r"F:\sheepy\00MyMLStudy\ml10Repositorys\02yolov5s\yolov5-7.0\yolov5-7.0\runs\train-seg1\exp_jqjps2\weights\\last.pt"

    img_dir = r"D:\04Bin\images\/"
    ...
    parser.add_argument('--name', default='exp_cmps', help='save results to project/name')
