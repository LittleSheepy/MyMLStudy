...
def parse_opt(known=False):
    ...
    pt_path = r"F:\sheepy\00MyMLStudy\ml10Repositorys\02yolov5s\yolov5-7.0\yolov5-7.0\runs\train-seg\exp_nmsz1024_11\weights\\last.pt"
    ...
    # parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg02_nm_nic.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg07_nm_wr.yaml', help='dataset.yaml path')
    #parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg12_cm_ps.yaml', help='dataset.yaml path')
    ...
    # parser.add_argument('--name', default='exp_nmnic1024_', help='save to project/name')
    # parser.add_argument('--name', default='exp_nmjqjps1024_', help='save to project/name')
    parser.add_argument('--name', default='exp_nmwr', help='save to project/name')
