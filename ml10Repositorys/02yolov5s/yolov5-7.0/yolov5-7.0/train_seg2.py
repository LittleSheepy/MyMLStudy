...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg13_cm_ewmps.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='exp_cmewm', help='save to project/name')
