...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg10_dm_zskps.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='exp_dmzskps', help='save to project/name')
