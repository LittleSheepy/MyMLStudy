...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/02LG_DL/LG_DL_HD.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='LG_DL_HD', help='save to project/name')
...
# tensorboard --logdir D:\03GitHub\00myGitHub\MyMLStudy\ml10Repositorys\02yolov5s\yolov5-7.0\yolov5-7.0/runs\train