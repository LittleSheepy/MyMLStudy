...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/02LG_DL/LG_DL.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='LG_DL', help='save to project/name')
