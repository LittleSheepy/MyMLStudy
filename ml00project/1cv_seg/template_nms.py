...
if __name__ == "__main__":
    dir_root = r"D:\04DataSets\02\images/"
    img_path = dir_root + "CB_00003.png"
    template_path = "./template.png"
    template2_path = "./template2.png"
    template3_path = "./template3.png"
    defect2_path = "./defect2.png"
    img_rgb = cv2.imread(img_path)  # 需要检测的图片
    img_gray = cv2.cvtColor(img_rgb, cv2.COLOR_BGR2GRAY)  # 转化成灰色
    template_img = cv2.imread(template2_path, 0)  # 模板小图
    template_threshold = 0.4  # 模板置信度
