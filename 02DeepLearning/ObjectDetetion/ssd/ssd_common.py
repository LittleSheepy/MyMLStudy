...
def tf_ssd_bboxes_encode_layer(labels,
    ...
    yref, xref, href, wref = anchors_layer  # 38 38 1,   38 38 1,   4,   4
    ymin = yref - href / 2.
    xmin = xref - wref / 2.
    ymax = yref + href / 2.
    xmax = xref + wref / 2.
    ...
    def jaccard_with_anchors(bbox):
        """Compute jaccard score between a box and the anchors. 计算框和锚之间的jaccard分数。
        """
        int_ymin = tf.maximum(ymin, bbox[0])            # (38, 38, 4)
        ...
        jaccard = tf.div(inter_vol, union_vol)          # (38, 38, 4)
        return jaccard
    ...
    def body(i, feat_labels, feat_scores,
        ...
        mask = tf.greater(jaccard, feat_scores)     # (38, 38, 4) bool
