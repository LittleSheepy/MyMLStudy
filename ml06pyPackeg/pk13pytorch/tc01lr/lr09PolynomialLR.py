...
def draw_line(val):
    ...
    power = cv2.getTrackbarPos('power', 'Line Graph')

    # Create a PolynomialLR scheduler
    scheduler = PolynomialLR(optimizer, total_iters=400, power=power*0.1)
...
cv2.createTrackbar('power', 'Line Graph', 0, 100, draw_line)
draw_line(1)
