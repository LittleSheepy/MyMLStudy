...
if __name__ == "__main__":
    ...
    parser.add_argument('--root_path', type=str,
        default="icdar_c4_train_imgs/",
        help='The root directory of images.Only takes effect when mode=det ')
    parser.add_argument('--input_path', type=str,
        default=r"D:\01sheepy\01work\02tongllidianti\0dataset\04lcd\00biaozhu\00img_all\xml_txt/",
        help='Input_label or input path to be converted')
    parser.add_argument('--output_label', type=str,
        default=r"D:\01sheepy\01work\02tongllidianti\0dataset\04lcd\00biaozhu\00img_all\train_icdar2015_label.txt",
